...
describe("InputRadio", () => {
    ...
    test("render with basic props", () => {
        ...
        expect(component.find(".input-radio-wrapper input").prop("value")).toBe(
            "option1"
        );
        expect(component.find(".input-radio-wrapper span").text()).toBe(
            "Option1"
        );
    ...
    test("render valid value", () => {
        ...
        expect(
            component.find(".input-radio-wrapper input").at(0).prop("value")
        ).toBe("option1");
        expect(component.find(".input-radio-wrapper span").at(0).text()).toBe(
            "Option1"
        );
        expect(
            component.find(".input-radio-wrapper input").at(1).prop("value")
        ).toBe("option2");
        expect(component.find(".input-radio-wrapper span").at(1).text()).toBe(
            "Option2"
        );
