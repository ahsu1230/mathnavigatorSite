...
func Test_CreateUsers(t *testing.T) {
	...
	// Call Get All!
	recorder := utils.SendHttpRequest(t, http.MethodGet, "/api/users/all", nil)
...
func Test_SearchUsers(t *testing.T) {
	...
	recorder1 := utils.SendHttpRequest(t, http.MethodGet, "/api/users/all?search=Smith&pageSize=2&offset=0", nil)
	...
	recorder2 := utils.SendHttpRequest(t, http.MethodGet, "/api/users/all?search=Smith&pageSize=2&offset=2", nil)
...
func Test_GetUsersByGuardian(t *testing.T) {
	...
	// Call Get All!
	recorder := utils.SendHttpRequest(t, http.MethodGet, "/api/users/guardian/1", nil)
