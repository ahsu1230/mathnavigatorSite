...
// 	assert.EqualValues(t, 0, users[0].FamilyId)
// 	assert.EqualValues(t, "notes1", users[0].Notes)
...
// 	assert.EqualValues(t, 1, users[1].FamilyId)
// 	assert.EqualValues(t, "notes2", users[1].Notes)
