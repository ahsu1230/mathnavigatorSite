...
func Test_CreateLocations(t *testing.T) {
	...
	// Call Get All!
	recorder4 := sendHttpRequest(t, http.MethodGet, "/api/locations/all", nil)
...
func Test_UniqueLocationId(t *testing.T) {
	...
	recorder3 := sendHttpRequest(t, http.MethodGet, "/api/locations/location/loc1", nil)
	assert.EqualValues(t, http.StatusOK, recorder3.Code)
...
func Test_UpdateLocation(t *testing.T) {
	...
	recorder2 := sendHttpRequest(t, http.MethodPost, "/api/locations/location/loc1", updatedBody)
	assert.EqualValues(t, http.StatusOK, recorder2.Code)

	// Get
	recorder3 := sendHttpRequest(t, http.MethodGet, "/api/locations/location/loc1", nil)
	assert.EqualValues(t, http.StatusNotFound, recorder3.Code)
	recorder4 := sendHttpRequest(t, http.MethodGet, "/api/locations/location/loc2", nil)
	assert.EqualValues(t, http.StatusOK, recorder4.Code)
...
func Test_DeleteLocation(t *testing.T) {
	...
	// Delete
	recorder2 := sendHttpRequest(t, http.MethodDelete, "/api/locations/location/loc1", nil)
	assert.EqualValues(t, http.StatusOK, recorder2.Code)
