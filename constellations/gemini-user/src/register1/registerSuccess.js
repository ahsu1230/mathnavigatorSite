        ...
        if (wasClass) {
            instructions = (
                <p className="class">
                    ...
                    Failure to submit payment on-time may result in losing this
            ...
            instructions = (
                <p className="afh">
                    ...
                    <br />
                    Before the class begins, please be sure to have all relevant
                    materials prepared so you can use your time efficiently! If
                    you already have specific questions in mind, please email us
                    at <b>andymathnavigator@gmail.com</b> so your teacher can
