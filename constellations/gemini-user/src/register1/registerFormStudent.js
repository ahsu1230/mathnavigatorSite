...
export default class RegisterSectionFormStudent extends React.Component {
    ...
    renderContent = () => {
        return (
            <div className="content">
                <p>
                    Please fill out your student information below. We use this
                    information to contact you about important class updates, so
                    please use a valid email you frequently use. School
                    information is used to help us estimate your current level
                    and help us cater to your needs. This information is for our
                    purposes only and will NOT be shared with anyone.
                    <br />
                ...
                <div className="names">
                    <RegisterInput
                        ...
                        onChangeCallback={(e) =>
                            this.onChangeInput(e, "studentFirstName")
                        }
                    />
                    <RegisterInput
                        title="Last Name"
                        ...
                        placeholder="i.e. Kim"
                        onChangeCallback={(e) =>
                            this.onChangeInput(e, "studentLastName")
                        }
                    />
                </div>
                ...
                <RegisterInput
                    ...
                    onChangeCallback={(e) =>
                        this.onChangeInput(e, "studentEmail")
                    }
                    validators={[
                        {
                            validate: () => {
                                return (
                                    this.props.student.email != "" &&
                                    validateEmail(this.props.student.email)
                                );
                            },
                ...
                <RegisterInput
                    ...
                    onChangeCallback={(e) =>
                        this.onChangeInput(e, "studentSchool")
                    }
                />
                ...
                <div className="grades">
                    <RegisterInput
                        ...
                        onChangeCallback={(e) =>
                            this.onChangeInput(e, "studentGrade")
                        }
                        validators={[
                            {
                                validate: () => {
                    ...
                    <RegisterInput
                        ...
                        onChangeCallback={(e) =>
                            this.onChangeInput(e, "studentGraduationYear")
                        }
                        validators={[
                            {
                                validate: () => {
    ...
    render() {
        const nextSection = this.props.isAfh
            ? REGISTER_SECTION_CONFIRM
            : REGISTER_SECTION_FORM_GUARDIAN;
        return (
            <RegisterSectionBase
