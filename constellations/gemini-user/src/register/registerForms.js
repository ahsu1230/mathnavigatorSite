    ...
    render() {
        return (
            <section className="register-form student">
                <div className={"header-wrapper" + (this.props.valid ? " active" : "")}>
                    <div className="title">
                        <div className="step-wrapper">2</div>
                        <h2>Student Information</h2>
                    </div>
                    {this.props.valid && <div><img src={srcCheckmark}/></div>}
                </div>
                ...
                <div className="names">
                    <RegisterInput
                        ...
                        onChangeCallback={(e) => this.props.onChangeStateValue("studentFirstName", e.target.value)}
                        />
                    <RegisterInput
                        title="Last Name"
                        value={this.props.student.lastName}
                        placeholder="i.e. Kim"
                        onChangeCallback={(e) => this.props.onChangeStateValue("studentLastName", e.target.value)}
                        />
                </div>
                ...
                <RegisterInput
                    ...
                    onChangeCallback={(e) => this.props.onChangeStateValue("studentSchool", e.target.value)}
                />
                ...
                <div className="grades">
                    <RegisterInput
                        ...
                        onChangeCallback={(e) => this.props.onChangeStateValue("studentGrade", e.target.value)}
                        validators={[
                            { 
                                validate: () => { 
                    ...
                    <RegisterInput
                        ...
                        onChangeCallback={(e) => this.props.onChangeStateValue("studentGraduationYear", e.target.value)}
                        validators={[
                            { 
                                validate: () => { 
            ...
            <section className="register-form guardian">
                ...
                <div className="names">
                    ...
                    <RegisterInput
                        ...
                        placeholder="i.e. Kim"
                        onChangeCallback={(e) => this.props.onChangeStateValue("guardianLastName", e.target.value)}
                        />
                </div>
                <RegisterInput
                    className="email"
                    ...
                    placeholder="i.e. alicekim@gmail.com"
                    onChangeCallback={(e) => this.props.onChangeStateValue("guardianEmail", e.target.value)}
                    validators={[
                        { 
                            validate: () => { 
                ...
                <RegisterInput
                    ...
                    onChangeCallback={(e) => this.props.onChangeStateValue("guardianPhone", e.target.value)}
                    validators={[
                        { 
                            validate: () => { 
                ...
                <RegisterInput
                    ...
                    isTextArea={10}
                    onChangeCallback={(e) => this.props.onChangeStateValue("guardianAdditionalInfo", e.target.value)}
                />
            </section>
        );
    }
