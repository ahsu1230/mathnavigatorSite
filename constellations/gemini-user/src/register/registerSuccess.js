...
export default class RegisterPage extends React.Component {
    render() {
        ...
        if (wasClass) {
            instructions = (
                <p className="class">
                    Thank you for enrolling into our class.
                    We look forward to working with you!
                    As a reminder, payment is due before the first day of class. 
                    Failure to submit payment on-time may result in losing this enrollment reservation.
                    See you soon!
                </p>
            );
            linkBack = (
            ...
            linkRestart = (
                <Link to="/register" className="link-register">Enroll for another class</Link>
            );
        } else {
            instructions = (
                <p className="afh">
                    Thank you for attending our ask-for-help session.
                    ...
                    so your teacher can prepare to answer your question. 
                    See you soon!
                </p>
            );
            linkBack = (
            ...
            linkRestart = (
                <Link to="/register" className="link-register">Register for another Ask-for-Help session</Link>
            );
        }
